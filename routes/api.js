...
loghandler = {
    notparam: {
        ...
        getApikey: 'get apikey melalui owners giie , GRATIS !'
    },t
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'get apikey melalui owners giie , GRATIS !'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'gionova') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'gionova') return res.json(loghandler.invalidKey)
